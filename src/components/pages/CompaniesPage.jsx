...
const CompaniesPage = () => (
  <div className="pt-32 pb-24 px-8 md:px-16 animate-fade-in min-h-screen">
    ...
    <div className="grid grid-cols-1 gap-4">
      {/* Mukham */}
      <div className="group relative w-full h-[40vh] bg-[#D4D4D4] overflow-hidden flex items-center justify-center hover-target cursor-pointer transition-all duration-500 hover:h-[50vh]">
        ...
        <div className="relative z-10 text-center text-[#FAF7F2]">
          ...
          <div className="mt-8 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500">
             <button className="border border-[#FAF7F2] px-8 py-3 rounded-full hover:bg-[#FAF7F2] hover:text-[#0a0a0a] transition-all flex items-center gap-2 mx-auto">Visit Studio <ArrowRight size={16} /></button>
          </div>
        </div>
      </div>
      {/* Ver */}
      <div className="group relative w-full h-[40vh] bg-[#1a1a1a] overflow-hidden flex items-center justify-center hover-target cursor-pointer transition-all duration-500 hover:h-[50vh]">
        ...
        <div className="relative z-10 text-center text-[#FAF7F2]">
          ...
          <div className="mt-8 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500">
             <button className="border border-[#FAF7F2] px-8 py-3 rounded-full hover:bg-[#FAF7F2] hover:text-[#0a0a0a] transition-all flex items-center gap-2 mx-auto">Listen Now <Mic size={16} /></button>
          </div>
        </div>
      </div>
    </div>
